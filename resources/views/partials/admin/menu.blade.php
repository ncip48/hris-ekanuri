                            ...
                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'holiday-calender'
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'kontrak' ? 'active dash-trigger' : '' }}"
                                        ...
                                        <a class="dash-link" href="#">{{ __('Document Setup') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            @can('manage kontrak')
                                                <li
                                                    class="dash-item {{ request()->is('kontrak*') ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                ...
                                                <li
                                                    class="dash-item {{ request()->is('kontrak*') ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('kontrak.index') }}">{{ __('Contract') }}</a>
                                                </li>
                                            @endcan
                                        </ul>
                                    </li>
