...
{{--                                        @endif--}}
    ...
    @if(\Auth::user()->type != 'employee')
        <div class="row">
            <div class="col-md-6 ">
                <div class="card emp_details">
                    <div class="card-header"><h6 class="mb-0">{{__('Education Detail')}}</h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                {!! Form::label('education_start', __('Education Start'),['class'=>'form-label']) !!}
                                {!! Form::date('education_start', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('education_end', __('Education End'),['class'=>'form-label']) !!}
                                {!! Form::date('education_end', null, ['class' => 'form-control']) !!}
                            ...
                            <div class="form-group col-md-6">
                                {!! Form::label('education_title', __('Degree'),['class'=>'form-label']) !!}
                                {!! Form::text('education_title',null, ['class' => 'form-control']) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('education_mark', __('GPA'),['class'=>'form-label']) !!}
                                {!! Form::text('education_mark',null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 ">
                <div class="card emp_details">
                    <div class="card-header"><h6 class="mb-0">{{__('Language')}}</h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                {!! Form::label('language_writing', __('Written Language'),['class'=>'form-label']) !!}
                                {!! Form::text('language_writing', null, ['class' => 'form-control']) !!}
        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="card emp_details">
                    <div class="card-header"><h6 class="mb-0">{{__('Recent Job Detail')}}</h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                {!! Form::label('recent_job_start', __('Job Start'),['class'=>'form-label']) !!}
                                {!! Form::date('recent_job_start', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('recent_job_end', __('Job End'),['class'=>'form-label']) !!}
                                {!! Form::date('recent_job_end', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('recent_job_position', __('Position'),['class'=>'form-label']) !!}
                                {!! Form::text('recent_job_position', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('recent_job_company', __('Company Name'),['class'=>'form-label']) !!}
                                {!! Form::text('recent_job_company',null, ['class' => 'form-control']) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('recent_job_skill', __('Skills'),['class'=>'form-label']) !!}
                                {!! Form::text('recent_job_skill',null, ['class' => 'form-control']) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('recent_job_salary', __('Salary'),['class'=>'form-label']) !!}
                                {!! Form::text('recent_job_salary',null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 ">
                <div class="card emp_details">
                    <div class="card-header"><h6 class="mb-0">{{__('Certification')}}</h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                {!! Form::label('certification_start', __('Certification Start'),['class'=>'form-label']) !!}
                                {!! Form::date('certification_start', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('certification_end', __('Certification End'),['class'=>'form-label']) !!}
                                {!! Form::date('certification_end', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('certification_field', __('Certification Field'),['class'=>'form-label']) !!}
                                {!! Form::text('certification_field', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('certification_organizer', __('Organizer'),['class'=>'form-label']) !!}
                                {!! Form::text('certification_organize',null, ['class' => 'form-control']) !!}
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::text('certification_cost',null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="card emp_details">
                    <div class="card-header"><h6 class="mb-0">{{__('Emergency Contact Detail')}}</h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                {!! Form::label('emergency_contact_name', __('Contact Name'),['class'=>'form-label']) !!}
                                {!! Form::text('emergency_contact_name', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('emergency_contact_name', __('Relation'),['class'=>'form-label']) !!}
                                {!! Form::text('emergency_contact_name', null, ['class' => 'form-control']) !!}

                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('emergency_contact_address', __('Address'),['class'=>'form-label']) !!}
                                {!! Form::text('emergency_contact_address', null, ['class' => 'form-control']) !!}
