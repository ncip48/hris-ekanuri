...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="lg" data-url="{{ route('add_personal_report') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create New Individual Report')}}" class="btn btn-sm btn-primary">
