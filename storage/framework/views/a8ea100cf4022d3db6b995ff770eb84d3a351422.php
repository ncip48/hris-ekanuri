...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="hrmpermission" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <?php
                        $modules = ['hrm dashboard', 'employee', 'employee profile', 'department', 'designation', 'branch', 'document type', 'document', 'payslip type', 'allowance', 'commission', 'allowance option', 'loan option', 'deduction option', 'loan', 'saturation deduction', 'other payment', 'overtime', 'set salary', 'pay slip', 'company policy', 'appraisal', 'goal tracking', 'behavior', 'rating behavior', 'goal type', 'indicator', 'event', 'meeting', 'training', 'trainer', 'training type', 'award', 'award type', 'resignation', 'travel', 'promotion', 'complaint', 'warning', 'termination', 'termination type', 'job application', 'job application note', 'job onBoard', 'job category', 'job', 'job stage', 'custom question', 'interview schedule', 'estimation', 'holiday', 'transfer', 'announcement', 'leave', 'leave type', 'attendance', 'extended contract', 'kontrak', 'personal report', 'sub department', 'level', 'class', 'reimbursement', 'employee schedule', 'change schedule', 'overtime request','shifting'];
                    ?>
...
<?php /**PATH D:\XAMPP\htdocs\hris-ekanuri\resources\views/role/create.blade.php ENDPATH**/ ?>