<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="<?php echo e(route('sub-department.index')); ?>"
            class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('sub-department*') ? 'active' : ''); ?>"><?php echo e(__('Sub Department')); ?>
        ...
        <a href="<?php echo e(route('class.index')); ?>"
            class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('class*') ? 'active' : ''); ?>"><?php echo e(__('Class')); ?>
...
<?php /**PATH D:\XAMPP\htdocs\hris-ekanuri\resources\views/layouts/hrm_setup.blade.php ENDPATH**/ ?>